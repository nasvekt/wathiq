...
const FileUploader: React.FC<Props> = ({ mode, onSubmit, onBack }) => {
  ...
  const COLUMN_MAP: Record<string, string> = {
    ...
    'gross': 'total_gross_wage',
    'total salary': 'total_gross_wage',
    'total wage': 'total_gross_wage',
